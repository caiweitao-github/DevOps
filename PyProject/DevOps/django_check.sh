...
feishu_report() {
    curl -X POST -H "Content-Type: application/json" -d '{"msg_type":"text", "content":{"text": "'"$1"'"}}'\
    "https://open.feishu.cn/open-apis/bot/v2/hook/2cf9c7a9-d12b-436f-a052-b2381b496ad2" >/dev/null 2>&1
}
